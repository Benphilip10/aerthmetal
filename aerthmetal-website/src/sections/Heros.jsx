  ...
  return (
    <div className="w-full h-[650px] bg-hero-image padding max-container">
        ...
        <div className="pt-[150px]" >
            ...
            <button type="button" className="py-3 px-5 font-semibold rounded-md text-primary-blue bg-white hover:drop-shadow-lg hover:text-primary-blue hover:scale-110 hover:bg-[#D9DEE5] transition-all duration-300 ease-in" data-aos ="fade-up" data-aos-duration="900" data-aos-once="true">
                DISCOVER MORE
            </button>
        </div>
