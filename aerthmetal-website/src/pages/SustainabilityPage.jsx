...
const SustainabilityPage = () => {
  return (
    <div>
          ...
          {/* 1st Section */}
          <div className='mt-10'> 
              <div className=' h-full padding flex gap-5 items-center' data-aos='zoom-in-down' data-aos-duration='900'>
                <div>
                ...
                <div><img src={sustainability_img1}/></div>
              </div>
          </div>


          {/* 2nd Section */}
          <div className='h-full mt-10 bg-no-repeat bg-long-grey-curve relative' data-aos='zoom-in-up' data-aos-duration='900'> 
              <div className="h-[700px] padding flex flex-row-reverse gap-20 justify-between items-center">
                ...
                <div><img src={sustainability_img2}/></div>
              </div>
          </div>


          {/* 3rd Section */}
          <div className='h-full mt-10 bg-no-repeat bg-long-red-curve relative' data-aos='zoom-in-up' data-aos-duration='900'> 
              <div className="h-[700px] padding flex flex-row gap-20 justify-between items-center">
                ...
                <div><img src={sustainability_img3}/></div>
              </div>
          </div>
